...
形式: "A {image_style_desc} of [具体的な主題], [詳細], clean lines, geometric shapes, {image_palette_desc} color palette, white background, no text, no people faces, minimalist, professional"

ルール:
- 必ず "{image_style_desc}" スタイルで統一する
- カラーパレットは "{image_palette_desc}" で全スライド統一する
...
## image_prompt ルール（英語で記述・厳守）
形式: "A {image_style_desc} of [具体的な主題], [詳細], clean lines, geometric shapes, {image_palette_desc} color palette, white background, no text, no people faces, minimalist, professional"
- 必ず "{image_style_desc}" スタイルで統一
- カラーパレットは "{image_palette_desc}" で全スライド統一
- 必ず "white background, no text, no people faces" を含める
- chart_data を含むスライドでは image_prompt は空文字列 "" にすること
{chart_instructions}
## その他
